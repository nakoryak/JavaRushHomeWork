...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory{
        ...
        static AtomicInteger factoriesAmount = new AtomicInteger(0);
        AtomicInteger threadsAmount = new AtomicInteger(0);
        ThreadGroup threadGroup;
        int currentPoolNumber;

        public AmigoThreadFactory() {
            currentPoolNumber = factoriesAmount.incrementAndGet();
        ...
        public Thread newThread(Runnable r) {
            ...
            newThread.setName(newThread.getThreadGroup().getName() + "-pool-" + currentPoolNumber + "-thread-" + threadsAmount.incrementAndGet());
            return newThread;
        }
    }
}
